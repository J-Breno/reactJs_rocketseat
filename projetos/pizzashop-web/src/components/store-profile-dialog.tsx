        ...
        <>
            <DialogContent>
                <DialogHeader>
                    ...
                    <DialogDescription>Atualize as informações do seu estabelecimento vivíveis ao seu cliente</DialogDescription>
                </DialogHeader>
                <form onSubmit={handleSubmit(handleUpdateProfile)}>
                    ...
                    <DialogFooter>
                        ...
                        <Button variant={"success"} disabled={isSubmitting} type="submit">Salvar</Button>
                    </DialogFooter>
                </form>
            </DialogContent>
        </>
